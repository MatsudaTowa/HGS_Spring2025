...
public:
	...
	typedef enum
	{
		SOUND_LABEL_TITLE = 0,		//BGM
		SOUND_LABEL_GAME,		//BGM
		SOUND_LABEL_RESULT,		//BGM
		SOUND_LABEL_HIT,		//BGM
		SOUND_LABEL_SHOT,		//BGM
		SOUND_LABEL_REFRECT,		//BGM
		SOUND_LABEL_SWING,		//BGM
		SOUND_LABEL_GAMEOVER,		//BGM
		SOUND_LABEL_MAX,			//最大値
	}SOUND_LABEL;
